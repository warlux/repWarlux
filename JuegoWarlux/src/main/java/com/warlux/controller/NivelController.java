...
//	}
	...
	public void guardarNiveles(){
		ArrayList<HashMap<String,Serializable>> mapaNiveles = new ArrayList<HashMap<String,Serializable>>();
		for(Nivel nivel: niveles){
			HashMap<String,Serializable> mapaNivel = new HashMap<String,Serializable>();
			...
			ArrayList<HashMap<String,Serializable>> mapaPistas = new ArrayList<HashMap<String,Serializable>>();
			for (int i = 0; i < nivel.getAncho(); i++) {
				for (int j = 0; j < nivel.getAlto(); j++) {
					if(nivel.getPosicion()[i][j] != null){
						HashMap<String,Serializable> mapaPista = new HashMap<String,Serializable>();
