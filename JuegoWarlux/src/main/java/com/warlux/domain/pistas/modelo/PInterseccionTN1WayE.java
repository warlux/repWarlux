...
public class PInterseccionTN1WayE extends Modelo {

	public PInterseccionTN1WayE() {
		super();
		nombre = "pInterseccionTN1WayE";
		imagen = new ImageIcon(
				"src/main/resources/modeloPistas/pInterseccionTN1WayE.png");
	...
	public void cambiarImagenActivada() {
		imagen = new ImageIcon("src/main/resources/modeloPistasFocus/vpInterseccionTN1WayE1.png");

	}

	public void cambiarImagenDesactivada() {
		imagen = new ImageIcon("src/main/resources/modeloPistas/pInterseccionTN1WayE.png");

	}
	
	@Override
	public void cambiarImagenCondicional(){
		imagen = new ImageIcon("src/main/resources/modeloPistasFocus/vpInterseccionTN1WayE2.png");
	}
