...
public class PInterseccionTO1WayOS extends Modelo {

	public PInterseccionTO1WayOS() {
		super();
		nombre = "pInterseccionTO1WayOS";
		imagen = new ImageIcon(
				"src/main/resources/modeloPistas/pInterseccionTO1WayOS.png");
	...
	public void cambiarImagenActivada() {
		imagen = new ImageIcon("src/main/resources/modeloPistasFocus/vpInterseccionTO1WayOS1.png");

	}

	public void cambiarImagenDesactivada() {
		imagen = new ImageIcon("src/main/resources/modeloPistas/pInterseccionTO1WayOS.png");

	}
	
	@Override
	public void cambiarImagenCondicional(){
		imagen = new ImageIcon("src/main/resources/modeloPistasFocus/vpInterseccionTO1WayOS2.png");
	}
}
