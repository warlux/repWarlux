...
public class PInterseccionTE1WaySN extends Modelo {
	...
	public PInterseccionTE1WaySN() {
		...
		imagen = new ImageIcon(
				"src/main/resources/modeloPistas/pInterseccionTE1WaySN.png");
	...
	public void cambiarImagenActivada() {
		imagen = new ImageIcon("src/main/resources/modeloPistasFocus/vpInterseccionTE1WaySN1.png");

	}

	public void cambiarImagenDesactivada() {
		imagen = new ImageIcon("src/main/resources/modeloPistas/pInterseccionTE1WaySN.png");

	}
	
	@Override
	public void cambiarImagenCondicional(){
		imagen = new ImageIcon("src/main/resources/modeloPistasFocus/vpInterseccionTE1WaySN2.png");
	}
}
