...
public class PInterseccionTO1WayN extends Modelo {

	public PInterseccionTO1WayN() {
		super();
		nombre = "pInterseccionTO1WayN";
		imagen = new ImageIcon(
				"src/main/resources/modeloPistas/pInterseccionTO1WayN.png");
	...
	public void cambiarImagenActivada() {
		imagen = new ImageIcon("src/main/resources/modeloPistasFocus/vpInterseccionTO1WayN1.png");

	}

	public void cambiarImagenDesactivada() {
		imagen = new ImageIcon("src/main/resources/modeloPistas/pInterseccionTO1WayN.png");

	}
	
	@Override
	public void cambiarImagenCondicional(){
		imagen = new ImageIcon("src/main/resources/modeloPistasFocus/vpInterseccionTO1WayN2.png");
	}
}
